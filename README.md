...
Dựa trên starter project, đã phát triển thêm để mang đến âm thanh, animation, sinh động nhất.  
Các enemy được trang bị AI, khiến chúng (rất) khó để có thể đánh bại.  
